...
<html lang="en">
    <head>
        ...
        <link
            rel="shortcut icon"
            href="../../../assets/images/logo-mining.png"
        />
                    ...
                    <div class="row w-100 mx-0 auth-page">
                        <div class="col-md-8 col-xl-6 mx-auto">
                            <div class="card">
                                <div class="row">
                                    <div
                                        class="col-md-4 pe-md-0 col-md-4 d-flex align-items-center justify-content-center"
                                    >
                                        <img
                                            width="auto"
                                            height="300"
                                            src="/assets/images/gama-ambient.jpg"
                                            alt="Logo"
                                            class="w-[200px] h-[300px] tw-object-fill"
                                        />
                                    </div>
                                    <div class="col-md-8 ps-md-0">
                                        ...
                                        >
                                            ...
                                            <h5
                                                class="text-muted fw-normal mb-4 mt-4"
                                            >
