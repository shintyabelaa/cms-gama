                            ...
                            <div class="auth-form-wrapper px-4 pt-2 pb-5">
                                <form action="{{ route('data-admin.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ old('name') }}" placeholder="Nama">
                                        @error('name')
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select name="role"
                                            ...
                                            <option @selected(old('role') == 'kasir') value="kasir">Kasir</option>
                                            <option @selected(old('role') == 'dapur') value="dapur">Dapur</option>
                                        </select>
                                        @error('role')
                                            <span class="tw-text-red-500 tw-text-xs">{{ $message }}</span>
                                        @enderror
